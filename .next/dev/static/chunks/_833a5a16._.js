...
const isConfigValid = ()=>{
    const isValid = firebaseConfig.apiKey && firebaseConfig.apiKey.length > 10 && firebaseConfig.authDomain && firebaseConfig.projectId && firebaseConfig.storageBucket && firebaseConfig.messagingSenderId && firebaseConfig.appId;
    if (!isValid) {
...
if (isConfigValid()) {
    try {
        ...
        firestore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFirestore"])(app);
...
const isFirebaseInitialized = ()=>app !== null && auth !== null && firestore !== null;
;
...
//# sourceMappingURL=_833a5a16._.js.map